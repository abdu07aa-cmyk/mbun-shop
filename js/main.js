      ...
      bodyHtml: `
        <div class="form-grid">
          <label class="form-field">
            ...
            <input type="text" id="pfName" value="${Utils.escapeHtml(product?.name || '')}" placeholder="mis. Aqua 600ml">
          </label>
          <label class="form-field">
            <span>Kategori</span>
            <input type="text" id="pfCategory" value="${Utils.escapeHtml(product?.category || '')}" placeholder="mis. Minuman">
          </label>
          <label class="form-field">
          ...
          <label class="form-field">
            <span>Stok</span>
            <input type="number" id="pfStock" value="${product?.stock ?? ''}" placeholder="0" min="0">
          </label>
          <label class="form-field">
            <span>Emoji</span>
            <input type="text" id="pfEmoji" value="${product?.emoji || '📦'}" placeholder="📦">
          </label>
